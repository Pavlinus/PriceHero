...
class M_CheapHolidays
{
    ...
    */
    public static function Instance()
    {
        ...
        {
            self::$instance = new M_CheapHolidays();
        }
    ...
    {
        $query = "SELECT game_id FROM t_cheap_holidays";
    ...
    private function delete($arId)
    {
        $in = implode(",", $arId);
        $where = "game_id IN ($in)";
        $this->msql->Delete('t_cheap_holidays', $where);
    ...
    private function add($arId)
    {
        ...
        foreach($arId as $value)
        {
            ...
            $this->msql->Insert('t_cheap_holidays', $object);
